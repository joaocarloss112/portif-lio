      ...
      <View style={styles.hero}>
        ...
        <View style={styles.textArea}>
          ...
          <Text style={styles.paragraph}>
            ...
            utilizando Django, React e Next, com projetos Mobile com EXPO e atualmente estou desenvolvendo um projeto de automação com N8N.
            </Text>
        </View>
        ...
        <View style={styles.skillsSection}>
          ...
          <View style={styles.skillsGrid}>
            {["React", "Next.js", "Django", "MySQL", "Java", "Python","EXPO","N8N",].map((skill) => (
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 35, fontWeight: "bold", textAlign: "center" },
  paragraph: { fontSize: 16, textAlign: "justify", marginTop: 10 },
